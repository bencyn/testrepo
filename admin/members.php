                  ...
                  <div>
                      <div>
                          <table class="table  table-striped table-bordered table-hover dataTable no-footer" data-id="members_table" role="grid">
                              <thead>
                              <tr role="row">
                                  <th class="sorting_asc wid-30" tabindex="0" rowspan="1" colspan="1">Full Name(s)</th>
                                  <th class="sorting wid-25" tabindex="0" rowspan="1" colspan="1">National Id</th>
                      ...
                      <div class="col-8">
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <input type="hidden" value="" name="Id"/> 
                            <div class="col-lg-3  text-lg-right">
                              <label for="required2" class="form-control-label">Role*</label>
                            </div>
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <span class="input-group-addon input_email"><i
                                      ...
                                      <select class="form-control" name="role" id="role">
                                        ...
                                        <option value="owners" >vehicle ownership</option>
                                      </select>
                                     <span class="help-block"></span>
                                </div>
